...
async def _security_headers(request: Request, call_next):
    ...
    response.headers["Content-Security-Policy"] = (
        ...
        "script-src 'self' 'unsafe-inline' "
            "https://js.stripe.com https://unpkg.com https://cdn.jsdelivr.net "
        ...
        "connect-src 'self' "
            "https://api.stripe.com https://nominatim.openstreetmap.org "
            "https://translate.googleapis.com https://translate-pa.googleapis.com "
            "https://unpkg.com https://www.gstatic.com; "
        "frame-src "
            "https://js.stripe.com https://www.youtube.com https://www.youtube-nocookie.com "
            "https://translate.google.com https://*.googleapis.com; "
        "object-src 'none'; "
        "base-uri 'self';"
    )
