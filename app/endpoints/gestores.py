...
# (GET)    /gestores              - Lista todos os gestores.
# (GET)    /gestores/adesoes      - Estatísticas de novas adesões por dia.
# (GET)    /gestores/{id}         - Exibe os dados de um gestor específico.
# (POST)   /gestores              - Cria um gestor manualmente.
# (PUT)    /gestores/conta        - Atualiza o perfil do gestor autenticado.
# (PUT)    /gestores/{id}         - Atualiza um gestor.
# (DELETE) /gestores/{id}         - Remove um gestor.
