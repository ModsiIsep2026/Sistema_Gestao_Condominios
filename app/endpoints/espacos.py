...
# (GET)    /espacos - Lista os espaços de um edifício.
# (GET)    /espacos/{id} - Exibe os dados de um espaço.
# (POST)   /espacos - Cria um novo espaço.
# (PUT)    /espacos/{id} - Atualiza um espaço.
