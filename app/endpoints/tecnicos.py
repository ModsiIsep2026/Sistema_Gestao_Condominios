...
# (PUT)    /tecnicos/conta        - Atualiza o perfil do técnico autenticado.
# (PUT)    /tecnicos/{id}         - Atualiza os dados de um técnico (gestor).
# (DELETE) /tecnicos/{id}         - Remove um técnico (gestor).
