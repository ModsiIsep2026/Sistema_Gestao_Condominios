...
# (GET)    /parceiros/{id} - Mostra os dados de um parceiro.
# (POST)   /parceiros - Cria um novo parceiro (apenas admin).
# (PUT)    /parceiros/{id} - Atualiza os dados de um parceiro (apenas admin).
# (DELETE) /parceiros/{id} - Remove um parceiro (apenas admin).
