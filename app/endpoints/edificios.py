...
# (GET)    /edificios - Lista os edifícios do gestor autenticado.
# (GET)    /edificios/todos - Lista todos os edifícios do sistema.
# (GET)    /edificios/{id} - Exibe os dados de um edifício específico.
# (POST)   /edificios - Cria um novo edifício.
# (PUT)    /edificios/{id} - Atualiza um edifício.
# (DELETE) /edificios/{id} - Remove um edifício.
