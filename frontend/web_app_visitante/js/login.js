...
(function () {
    ...
    function redirecionarPorTipo(tipo) {
        if (tipo === "condomino") {
            window.location.replace("../web_app_condomino/");
        } else if (tipo === "tecnico") {
            window.location.replace("../web_app_tecnico/");
        } else if (tipo === "gestor") {
            window.location.replace("../web_app_gestor/");
        } else if (tipo === "admin") {
            window.location.replace("../web_app_admin/");
        } else {
